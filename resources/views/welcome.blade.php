...
@section('title', 'BukuTernak - Manajemen Ternak Modern')
...
<div class="flex flex-col min-h-screen bg-white">
  ...
  <header class="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-gray-100 px-5 py-3.5 flex items-center justify-between">
    ...
    <div class="flex items-center gap-2">
      <a href="{{ route('login') }}" class="text-sm font-medium px-3 py-1.5 rounded-xl text-gray-700 hover:bg-gray-100 transition-colors">Masuk</a>
      <a href="{{ route('register') }}" class="text-sm px-4 py-1.5 rounded-xl bg-[#3c8d5a] text-white font-medium hover:bg-[#337a4e] transition-colors">Daftar Gratis</a>
    </div>
  </header>
  ...
  <main class="flex-1">
    ...
    <section class="relative overflow-hidden px-5 pt-16 pb-20 text-center">
      ...
      <div class="max-w-2xl mx-auto">
        ...
        <div class="anim d300 flex flex-col sm:flex-row gap-3 justify-center">
          <a href="{{ route('register') }}" class="inline-flex items-center justify-center gap-2 text-base px-8 h-12 rounded-xl bg-[#3c8d5a] text-white font-medium shadow-lg shadow-[#3c8d5a]/30 hover:bg-[#337a4e] transition-colors w-full sm:w-auto">
            Mulai Gratis
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
          </a>
          <a href="{{ route('login') }}" class="inline-flex items-center justify-center text-base px-8 h-12 rounded-xl border border-gray-200 text-gray-700 font-medium hover:bg-gray-50 transition-colors w-full sm:w-auto">
            Sudah punya akun
          </a>
        </div>
      ...
      <div class="max-w-4xl mx-auto">
        <div class="flex flex-col sm:flex-row justify-center gap-6">
          <div class="bg-[#f8faf8] rounded-2xl shadow-sm border border-gray-100 px-10 py-8 flex flex-col items-center w-full max-w-xs">
            ...
            <div class="text-4xl font-extrabold text-gray-900 mb-1">{{ number_format($userCount) }}</div>
          ...
          <div class="bg-[#f8faf8] rounded-2xl shadow-sm border border-gray-100 px-10 py-8 flex flex-col items-center w-full max-w-xs">
            ...
            <div class="text-4xl font-extrabold text-gray-900 mb-1">{{ number_format($activeCycleCount) }}</div>
      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-50">
            <div class="h-9 w-9 bg-[#3c8d5a]/10 rounded-xl flex items-center justify-center mb-3 text-lg">{{ $f['icon'] }}</div>
      ...
      <div class="max-w-3xl mx-auto">
        <div class="grid gap-8 sm:grid-cols-2 items-center">
          <div>
            ...
            <ul class="space-y-3">
              @foreach(['Catat konsumsi pakan harian','Pantau angka kematian ternak','Hitung total biaya operasional','Ketahui laba-rugi per siklus','Akses dari HP kapan saja'] as $item)
    ...
    <section class="px-5 py-14 bg-[#3c8d5a]">
      <div class="max-w-xl mx-auto text-center">
        ...
        <a href="{{ route('register') }}" class="inline-flex items-center justify-center text-base h-12 px-8 rounded-xl bg-white text-[#3c8d5a] font-semibold hover:bg-gray-50 transition-colors">
  ...
  <footer class="border-t px-5 py-7 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-gray-400">
    ...
    <p>&copy; {{ date('Y') }} BukuTernak. Semua hak dilindungi.</p>
    <div class="flex gap-4">
      <a href="{{ route('login') }}" class="hover:text-[#3c8d5a] transition-colors">Masuk</a>
      <a href="{{ route('register') }}" class="hover:text-[#3c8d5a] transition-colors">Daftar</a>
    </div>
  </footer>
