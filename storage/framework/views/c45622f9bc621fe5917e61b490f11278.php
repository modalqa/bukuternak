<?php $__env->startSection('title', 'Masuk - BukuTernak'); ?>
...
<div class="flex min-h-screen items-center justify-center px-4 py-12 bg-[#F8FAF8]">
    ...
    <div class="w-full max-w-sm bg-white rounded-2xl shadow-sm p-8">
        <div class="text-center mb-6">
            ...
            <h1 class="text-xl font-bold text-gray-900">Masuk ke BukuTernak</h1>
            <p class="text-sm text-gray-500 mt-1">Masukkan email dan password untuk masuk</p>
        </div>

        <?php if($errors->any()): ?>
            <div class="rounded-lg bg-red-50 p-3 mb-4 text-sm text-red-700">
        ...
        <p class="mt-4 text-center text-sm text-gray-500">
            Belum punya akun?
            <a href="<?php echo e(route('register')); ?>" class="text-[#3c8d5a] font-medium hover:underline">Daftar</a>
        </p>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/fataorgana/Project/buku-ternak/resources/views/auth/login.blade.php ENDPATH**/ ?>