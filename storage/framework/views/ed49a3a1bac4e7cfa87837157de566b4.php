...
<div class="flex flex-col min-h-screen bg-gray-50">
    ...
    <header class="sticky top-0 z-50 bg-[#3c8d5a] text-white shadow-md">
        <div class="flex h-14 items-center px-4 max-w-xl mx-auto gap-3">
            <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-2 mr-auto">
    ...
    <nav class="fixed bottom-0 left-0 right-0 z-50 border-t bg-white shadow-lg">
        <div class="flex items-center justify-around py-2 max-w-lg mx-auto">
            ...
            <?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <a href="<?php echo e(route($item['route'])); ?>" class="flex flex-col items-center gap-0.5 px-5 py-1 rounded-xl transition-colors <?php echo e($isActive ? 'text-[#3c8d5a]' : 'text-gray-400'); ?>">
                    <?php if($item['icon'] === 'grid'): ?>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 <?php echo e($isActive ? 'stroke-[2.5]' : 'stroke-[1.5]'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4 5a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H5a1 1 0 01-1-1V5zm10 0a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 15a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H5a1 1 0 01-1-1v-4zm10 0a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 01-1-1v-4z"/></svg>
                    <?php elseif($item['icon'] === 'refresh'): ?>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 <?php echo e($isActive ? 'stroke-[2.5]' : 'stroke-[1.5]'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg>
                    <?php elseif($item['icon'] === 'chart'): ?>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 <?php echo e($isActive ? 'stroke-[2.5]' : 'stroke-[1.5]'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                    <?php else: ?>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 <?php echo e($isActive ? 'stroke-[2.5]' : 'stroke-[1.5]'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                    <?php endif; ?>
                    <span class="text-[10px] <?php echo e($isActive ? 'font-semibold' : 'font-normal'); ?>"><?php echo e($item['label']); ?></span>
                </a>
...
<?php echo $__env->make('layouts.base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/fataorgana/Project/buku-ternak/resources/views/layouts/app.blade.php ENDPATH**/ ?>