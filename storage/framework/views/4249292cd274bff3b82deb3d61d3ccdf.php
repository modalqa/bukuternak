...
<a href="<?php echo e(route('cycles.show', $cycle)); ?>">
    <div class="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow cursor-pointer px-4 py-4">
        <div class="flex items-start justify-between mb-2">
            <div>
                ...
                <p class="text-xs text-gray-500"><?php echo e($cycle->livestock_type); ?></p>
            </div>
        ...
        <div class="flex flex-wrap gap-x-4 gap-y-1 text-xs text-gray-500">
            <span>Mulai <?php echo e($cycle->start_date->translatedFormat('j M Y')); ?></span>
            <?php if(!$cycle->isActive() && $cycle->end_date): ?>
                <span>Selesai <?php echo e($cycle->end_date->translatedFormat('j M Y')); ?></span>
            <?php endif; ?>
            <span><?php echo e(CSS::formatNumber($cycle->initial_count)); ?> ekor</span>
            <span>Modal <?php echo e(CSS::formatCurrency((float)$cycle->initial_capital)); ?></span>
        </div>
    </div>
</a>
<?php /**PATH /Users/fataorgana/Project/buku-ternak/resources/views/cycles/_card.blade.php ENDPATH**/ ?>