<?php $__env->startSection('title', 'Tambah Kematian - BukuTernak'); ?>
...
<div>
    ...
    <div class="bg-white rounded-2xl shadow-sm p-6">
        <form method="POST" action="<?php echo e(route('cycles.mortality.store', $cycle)); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-1.5">
                ...
                <input name="count" type="number" min="1" placeholder="5" required value="<?php echo e(old('count')); ?>"
                    class="w-full h-12 rounded-xl border border-gray-200 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-[#3c8d5a]" />
            </div>
            <div class="space-y-1.5">
                <label class="block text-sm font-medium text-gray-700">Penyebab (opsional)</label>
                <input name="cause" type="text" placeholder="Contoh: Penyakit, cuaca" value="<?php echo e(old('cause')); ?>"
                    class="w-full h-12 rounded-xl border border-gray-200 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-[#3c8d5a]" />
            </div>
            <div class="space-y-1.5">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/fataorgana/Project/buku-ternak/resources/views/cycles/mortality/create.blade.php ENDPATH**/ ?>